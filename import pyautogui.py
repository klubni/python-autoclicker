...
window = Tk()
window.title('ssfsfsf')
btn = Button(window, text="Запуск Автокликера")
btn.grid(column=1, row=0)
mouse = tk.Entry(window)
mouse.grid(column=3, row= 2)
btn2 = Button(window,text = 'да')
btn2.grid(column = 4,row = 5)
btn3 = Button(window,text = 'да')
btn3.grid(column = 5,row = 6)
speed = tk.Entry(window)
speed.grid(column=5, row= 4)
window = mainloop()
